...
public class SyncPropertyKeyTest {
	...
	public void testPropertyKey() {
		...
		SyncPropertyKey syncPropertyKey4 = new SyncPropertyKey(SOME_KIND1,
				SOME_PROPERTY_NAME1);
		SyncPropertyKey syncPropertyKey5 = new SyncPropertyKey(SOME_KIND1,
				SOME_PROPERTY_NAME2);
		SyncPropertyKey syncPropertyKey6 = new SyncPropertyKey(SOME_KIND1,
				SOME_PROPERTY_NAME2, SOME_VALUE1);
		SyncPropertyKey syncPropertyKey7 = new SyncPropertyKey(SOME_KIND1,
				SOME_PROPERTY_NAME2, SOME_VALUE2);
